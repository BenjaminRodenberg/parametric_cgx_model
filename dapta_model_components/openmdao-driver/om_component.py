...
# import scipy.optimize._slsqp_py as scipy_slsqp  # type: ignore
...
class OMexplicitComp(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # # non-standard slsqp required - see dapta scipy fork
        # if scipy_slsqp._start_majoriter:
        #     self.get_grads = True
        #     print("get grads in the next compute...")
        # else:
        # self.get_grads = False
